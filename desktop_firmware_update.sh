...
sudo chmod +x /home/pi/di_update/Raspbian_For_Robots/upd_script/update_GoPiGo_Firmware.sh
...
sudo chmod +x /home/pi/di_update/Raspbian_For_Robots/upd_script/update_GrovePi_Firmware.sh